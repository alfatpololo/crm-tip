...
export default function RealisasiCustomerPage() {
  const now = new Date();
  ...
  return (
    <DashboardLayout>
      <div className="space-y-8">
        <PageHero title="Realisasi Customer" subtitle="Lihat realisasi customer bulanan. Kalender untuk tampilan harian." badge={{ icon: 'ri-user-received-line', text: 'Realisasi' }} variant="violet" />
        <PageCard accent="violet" icon="ri-user-received-line" title="Ringkasan Bulanan">
        ...
        <PageCard accent="violet" icon="ri-calendar-line" title="Kalender (Lihat Harian)">
